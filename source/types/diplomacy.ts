...
export type CrashBcoinButtonController =
	ButtonModernController<UnsafeTradeButtonModel> & {
...
export type TradeButtonController =
	ButtonModernController<UnsafeTradeButtonModel> & {
		defaults: () => UnsafeTradeButtonModel;
	};
...
export type SendExplorersButton =
	ButtonModern<UnsafeSendExplorersButtonOptions> & {
		afterRender: () => void;
	};
