...
export type ScienceManager = TabManager<
	UnsafeMeta<UnsafeTech> | UnsafeMeta<UnsafePolicy>
> & {
	game: GamePage;
...
export type PolicyBtnController =
	BuildingNotStackableBtnController<UnsafePolicyBtnModel> & {
...
export type PolicyPanel = Panel<
	BuildingResearchBtn<UnsafePolicyButtonOptions>
> & {
...
export type TechButtonController =
	BuildingNotStackableBtnController<UnsafeTechButtonModel> & {
...
export type Library = Tab<
	unknown,
	BuildingResearchBtn<UnsafeTechButtonOptions>
> & {
