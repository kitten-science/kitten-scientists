...
export type ChallengeBtnController<
	TModel extends
		| UnsafeChallengeBtnModel<UnsafeChallengeButtonOptions>
		| unknown = unknown,
...
export type UnsafeChallenge = {
	...
	stackOptions?: Record<
		string,
		{ LDRLimit: number; noStack?: boolean; capMagnitude?: number }
	>;
...
export type UnsafeChallengeButtonOptions = {
	id: Challenge;
	controller: ChallengeBtnController<
		UnsafeChallengeBtnModel<UnsafeChallengeButtonOptions>
	>;
};

export type UnsafeChallengeBtnModel<
	TModelOptions extends UnsafeChallengeButtonOptions,
> = {
