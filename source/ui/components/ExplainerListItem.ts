...
export type ExplainerListItemOptions<TKittenGameLiteral extends `$${string}`> =
	UiComponentOptions & ThisType<ExplainerListItem<TKittenGameLiteral>>;

export class ExplainerListItem<
...
> extends UiComponent {
	...
	constructor(
		...
		this.element = $("<li/>", { text: parent.host.engine.i18n(key) }).addClass(
			styles.explainer,
		);
	}
