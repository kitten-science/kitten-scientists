...
1. The **latest stable** release.
    ...
    <https://github.com/kitten-science/kitten-scientists/releases/tag/v2.0.0-beta.4>.
...
```shell
docker run --publish 8080:8080 --rm ghcr.io/kitten-science/kitten-scientists:2.0.0-beta.4
```
