        ...
        children: [
          ...
          new ButtonListItem(
            ...
            new TextButton(
              host,
              "KS settings only",
              "Copy only the settings of Kitten Scientists",
              {
          ...
          new ButtonListItem(
            host,
            new TextButton(host, "KG save game", "Copy the entire Kittens Game save.", {
          ...
          new ButtonListItem(
            ...
            new TextButton(
              host,
              "KS settings only",
              "Load only the settings of Kitten Scientists",
              {
          ...
          new ButtonListItem(
            host,
            new TextButton(host, "KG save game", "Load an entire Kittens Game save.", {
          ...
          new ButtonListItem(
            host,
            new TextButton(host, "Store current", "Create a new state snapshot.", {
          ...
          new ButtonListItem(
            ...
            new TextButton(
              ...
              "Store a state that you have in your clipboard.",
              {
          ...
          new ButtonListItem(
            ...
            new TextButton(
              ...
              "Reset absolutely all KS settings to factory defaults.",
              {
  ...
  refreshUi(): void {
    ...
    for (const state of this.states) {
      const button = new TextButton(
        ...
        state.timestamp,
        { onClick: () => this.loadState(state.state) }
      );
